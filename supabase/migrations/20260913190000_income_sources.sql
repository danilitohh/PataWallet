-- Guarda fuentes de ingreso asociadas a cuentas de activo sin crear movimientos automáticos.
-- Los sueldos fijos alimentan la referencia mensual; los extras esporádicos son informativos.
...
alter table public.user_settings
  ...
  check (key in ('entered', 'theme', 'hiddenAmounts', 'motion', 'monthlySalaryMinor', 'payFrequency', 'financialOnboardingComplete', 'fixedExpenses', 'nextPayDate', 'incomeSources')),
...
-- La columna puede ser NULL para los tres ajustes financieros opcionales existentes,
-- pero una lista de fuentes siempre se guarda como un arreglo, aunque esté vacío.
alter table public.user_settings
