...
export function IncomeSettings() {
  ...
  return <section className="settings-group income-settings" id="ingresos">
    ...
    <form onSubmit={submit}>
      <Field label="Sueldo mensual equivalente" optional error={error}><input inputMode="decimal" value={salary} onChange={(event) => setSalary(formatInputAmount(event.target.value))} placeholder="2.500.000" /></Field>
