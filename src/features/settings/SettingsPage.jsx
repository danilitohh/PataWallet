import { Bell, CircleDollarSign, Eye, EyeOff, LogOut, Menu, Moon, Smartphone, Sun, UserRound } from 'lucide-react'
...
export function SettingsPage() {
  const { settings, notify, actions, isDemo, user, signOut } = useApp()
