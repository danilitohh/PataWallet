...
function AvailablePlanSummary({ available, hidden }) {
  if (available.monthlyFreeMinor === null) return <section className="feature-panel available-plan-summary"><h2>Dinero libre</h2><p>Completa tus ingresos y gastos fijos en <Link to="/cuentas">Cuentas</Link> para evaluar compras con una referencia personal.</p></section>
