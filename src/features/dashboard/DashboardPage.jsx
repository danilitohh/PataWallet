...
function AvailableMoneyCard({ available, hidden }) {
  if (available.monthlyFreeMinor === null) return <section className="feature-panel available-money-card"><div className="section-heading"><div><h2>Dinero libre</h2><p>El resultado aparece al completar tu punto de partida.</p></div><Link to="/cuentas#ingresos">Configurar</Link></div><p className="dashboard-empty__text">Necesitamos tu salario mensual, gastos fijos y pagos de deuda para decirte cuánto puedes usar con tranquilidad.</p></section>
