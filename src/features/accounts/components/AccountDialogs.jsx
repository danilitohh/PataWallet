  ...
  return (
    <SimpleDialog title="Agregar cuenta" close={() => { if (!savingRef.current) close() }}>
      <form onSubmit={submit}>
        ...
        <p className="helper">{assetOnly ? 'Escribe el saldo real que tienes hoy en esa cuenta, no la estimación de Inicio. Si aún registrarás ese sueldo como ingreso, deja el saldo inicial en 0 para no contarlo dos veces.' : 'El saldo inicial no cuenta como ingreso ni gasto.'}</p>
