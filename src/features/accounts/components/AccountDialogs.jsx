  ...
  return (
    <SimpleDialog title="Agregar cuenta" close={() => { if (!savingRef.current) close() }}>
      <form onSubmit={submit}>
        ...
        <p className="helper">{assetOnly ? 'Si ese dinero ya está en la cuenta, escribe el saldo actual. Si vas a registrar después el sueldo recibido como ingreso, deja el saldo inicial en 0 para no contarlo dos veces.' : 'El saldo inicial no cuenta como ingreso ni gasto.'}</p>
