...
test('completa el punto de partida con saldo real y deja los pagos pendientes aparte', async ({ page }) => {
  await page.goto('/')
  ...
  await page.getByRole('combobox', { name: 'Cuenta con tu dinero' }).selectOption('__new_account__')
  await page.getByRole('textbox', { name: 'Nombre de la cuenta' }).fill('Ahorros Bancolombia')
  await page.getByRole('textbox', { name: 'Saldo que tienes hoy' }).fill('3.200.000')
  ...
  await page.getByLabel('Pago mensual previsto').fill('100.000')
  await page.getByRole('button', { name: 'Continuar' }).click()
  ...
  await expect(page.getByText('no cambiará al guardar estos compromisos')).toBeVisible()
